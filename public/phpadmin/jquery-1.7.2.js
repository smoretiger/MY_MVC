...
(function (a, b) {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
        ...
        var e = function (a, b) {
            ...
            p = /"[^"\\\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, q = /(?:^|:|,)(?:\s*\[)+/g,
    ...
    var o = /[\t\r]/g, p = /\s+/, q = /\r/g, r = /^(?:button|input)$/i,
    ...
    f.event = {
        ...
        var n = m.getText = function (a) {
            ...
            preFilter: {
                CLASS: function (a, b, c, d, e, f) {
                    a = " " + a[1].replace(j, "") + " ";
                    if (f)return a;
                    for (var g = 0, h; (h = b[g]) != null; g++)h && (e ^ (h.className && (" " + h.className + " ").replace(/[\t\r]/g, " ").indexOf(a) >= 0) ? c || d.push(h) : c && (b[g] = !1));
                    return !1
                }, ID: function (a) {
        ...
        for (var r in o.match)o.match[r] = new RegExp(o.match[r].source + /(?![^\[]*\])(?![^\(]*\))/.source), o.leftMatch[r] = new RegExp(/(^(?:.|\r|)*?)/.source + o.match[r].source.replace(/\\(\d+)/g, q));
        o.match.globalPOS = p;
        var s = function (a, b) {
    ...
    var bC = /%20/g, bD = /\[\]$/, bE = /\r?/g, bF = /#.*$/, bG = /^(.*?):[ \t]*([^\r]*)\r?$/mg,
        ...
        load: function (a, c, d) {
            ...
            return this.map(function () {
                ...
                return c == null ? null : f.isArray(c) ? f.map(c, function (a, c) {
                    return {name: b.name, value: a.replace(bE, "\r")}
                }) : {name: b.name, value: c.replace(bE, "\r")}
            }).get()
        }
