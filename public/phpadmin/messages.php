...
PMA_messages['phpErrorsBeingSubmitted'] = "<div class=\"error\">在服务上检测到错误！<br/>正在提交您的设置，请耐心等待。<br/><img src=\"./<?= __PUBLIC__.'phpadmin/'?>pmahomme/img/ajax_clock_small.gif\" width=\"16\" height=\"16\" alt=\"ajax clock\"/></div>";
...
var themeCalendarImage = './<?= __PUBLIC__.'phpadmin/'?>pmahomme/img/b_calendar.png';
var pmaThemeImage = './<?= __PUBLIC__.'phpadmin/'?>pmahomme/img/';
